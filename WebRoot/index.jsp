...
<div class="ch-container">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <c:if test="${ session.userName != null}">
                        <li><a class="ajax-link" href="addBlog.jsp"><i class="glyphicon glyphicon-plus"></i><span>　写博客</span></a>
                        </li>
                        </c:if>
                    </ul>
                </div>
  ...
  <c:forEach items="${blogList }" var="e">
    <div class="row">
        <div class="box col-md-12">
            <div class="box-inner">
                <div class="box-header well" data-original-title="">
                    <h2><i class="glyphicon glyphicon-th"></i>${e.title}</h2>
            ...
            <div class="mc_embed_signup">
                <form action="//halalit.us3.list-manage.com/subscribe/post?u=444b176aa3c39f656c66381f6&amp;id=eeb0c04e84" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    <div>
                        ...
                        <div class="power_field"><input type="text" name="suggest" tabindex="-1" value=""></div>
                        <div class="clear"><input type="submit" value="您的建议" name="subscribe" class="button"></div>
                    </div>
                </form>
            </div>
